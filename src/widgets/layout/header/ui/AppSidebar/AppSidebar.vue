<template>
  <div :class="isVisible ? 'block' : 'hidden'" class="lg:hidden!">
    <ul
      class="fixed z-20 flex h-screen max-w-fit min-w-[200px] flex-col gap-4 bg-white p-[14px]"
    >
      <AppSidebarLink
...
import { ModalBackground } from '@/shared/ui/components'
